...
import 'package:scanqr_code/views/phieunhap_noibo_detail.dart';



class phieunhap_noidbo extends StatefulWidget {

  @override
  _phieunhap_noidboState createState() => _phieunhap_noidboState();
}

class _phieunhap_noidboState extends State<phieunhap_noidbo> {
  ...
  List<PhieuNhapModels> sampleData = [
    new PhieuNhapModels(
      tenphieu: "Phiếu 1",
      maThanhPham: "123456",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Phiếu nhập nội bộ kho", style: TextStyle(
                    ...
                    return GestureDetector(
                      onTap: (){
                        Navigator.of(context).push(
                            MaterialPageRoute(builder:(route)=>PhieuNhapDetailPage(phieuNhapModels: sampleData[index],)
                            )
                        );
                        print('Tapped ${index}');
                      },
