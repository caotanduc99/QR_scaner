...
import 'package:scanqr_code/views/phieuxuat_kho_detail.dart';

class phieuxuat_kho extends StatefulWidget {


  @override
  _phieuxuat_khoState createState() => _phieuxuat_khoState();
}

class _phieuxuat_khoState extends State<phieuxuat_kho> {
  ...
  List<PhieuXuatKhoModels> sampleData = [
    new PhieuXuatKhoModels(
        tenphieu: "Phiếu 1",
        maThanhPham: "123456",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Phiếu xuất kho", style: TextStyle(
                    ...
                    return GestureDetector(
                      onTap: (){
                        Navigator.of(context).push(
                            MaterialPageRoute(builder:(route)=>PhieuXuatKhoDetailPage(phieuXuatKhoModels: sampleData[index])
                            )
                        );
                        print('Tapped ${index}');
                      },
